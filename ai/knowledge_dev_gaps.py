...
TRAVEL_GAP_KNOWLEDGE = [
    ...
    {
        "persona": "travel",
        "q": "호주 여행 호주 여행 호주 여행 호주 여행 호주 여행 호주여행 호주코스 호주관광 오스트레일리아 시드니 멜버른 골드코스트",
...
- 레스토랑 팁 문화: 선택사항이나 10~15% 관행""",
    ...
    {
        "persona": "travel",
        "q": "두바이 여행 코스 두바이 여행 코스 추천 두바이 코스 두바이 일정 두바이 관광 두바이여행 두바이코스 두바이일정 두바이명소 아부다비 아랍에미리트 UAE 두바이 추천 두바이 가볼만한곳",
...
- 크리스마스 마켓 (11~12월): 뱅쇼(따뜻한 포도주) 필수 경험""",
    ...
    {
        "persona": "travel",
        "q": "여행보험 추천 여행자보험 가입 여행 보험 여행보험가입 해외여행 보험 여행자 보험 추천 여행보험 어디가 좋아 해외여행 중 응급상황 아프면 어떻게 병원 해외 의료 보험 대처",
