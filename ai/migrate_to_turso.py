...
_TABLES = {
    ...
    "memory_retrieval_events": ["query_hash", "persona", "session_kind", "top_source",
                                ...
                                "created_at"],
    "memory_retrieval_attributions": ["query_hash", "persona", "session_kind", "session_hash",
                                      "memory_ids_json", "feedback_rating", "feedback_at", "created_at"],
    "memory_utility": ["memory_id", "retrieved_count", "helpful_count", "harmful_count",
                       "utility_boost", "last_used_at"],
